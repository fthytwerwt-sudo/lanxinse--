...
- 在“澜心社剪辑”文件夹外新建工作区。
- 在“澜心社剪辑”文件夹外新建项目目录、报告目录、脚本目录、临时产物目录。
...
除非用户本轮明确授权例外路径，否则不得继续。

## 远端仓库硬约束

当前项目唯一允许写入 / push 的 GitHub 仓库是：
...
Codex 只能在“澜心社剪辑”授权文件夹内干活，只能把当前项目改动 push 到 `fthytwerwt-sudo/lanxinse--`；越界就 blocked。
