...
| `00_协作协议_collaboration_protocol.md` | 定义 GPT / Codex / Perplexity / Obsidian 分工 | 是 | 否 | P0 |
...
| `25_AGENTS机制迁移说明_agents_mechanism_migration_note.md` | 说明从旧 AGENTS 只迁移配合习惯、不迁移旧项目事实的边界 | 是 | 否 | P1 |
