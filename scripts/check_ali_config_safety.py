...
FILES_TO_SCAN = [
    ...
    ROOT / "执行日志_codex_log" / "107_AI需要的成片全量结构解析报告_finished_video_full_analysis_report.md",
    ROOT / "项目事实_project_facts" / "自动剪辑五结构成片方案_five_structure_final_video" / "20_视频结构公式库_video_structure_formula_library.md",
    ROOT / "项目事实_project_facts" / "自动剪辑五结构成片方案_five_structure_final_video" / "21_初剪完整性与素材连续性判断标准_rough_cut_integrity_continuity_standard.md",
    ROOT / "项目事实_project_facts" / "自动剪辑五结构成片方案_five_structure_final_video" / "22_成片样本类型与结构总表_finished_video_type_structure_inventory.md",
    ROOT / "项目事实_project_facts" / "自动剪辑五结构成片方案_five_structure_final_video" / "23_Codex成片解析字段规范_finished_video_analysis_schema.md",
    ROOT / "素材解析_pipeline_material_analysis" / "08_finished_video_analysis" / "成片样本清单_finished_video_inventory.csv",
    ROOT / "素材解析_pipeline_material_analysis" / "08_finished_video_analysis" / "成片结构矩阵_finished_video_structure_matrix.csv",
    ROOT / "素材解析_pipeline_material_analysis" / "08_finished_video_analysis" / "成片证据索引_finished_video_evidence_index.csv",
